...
if os.environ.get('HSELING_API_ANTIDICT_SETTINGS'):
...
if not app.debug:
    ...
    file_handler = TimedRotatingFileHandler(os.path.join(app.config['LOG_DIR'], 'hseling_api_antidict.log'), 'midnight')
