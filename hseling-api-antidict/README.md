...
## Development environment and release process
 ...
 - create virtualenv with Flask and Antidict installed into it (latter is installed in
...
install it (`pip install hseling_api_antidict.tar.gz`), ensure that configuration file exists and
`HSELING_API_ANTIDICT_SETTINGS` environment variable points to it, ensure that user has access to the
